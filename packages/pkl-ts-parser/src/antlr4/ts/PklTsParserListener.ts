...
export class PklTsParserListener implements ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    enterModuleExtendsOrAmendsClause?: (ctx: ModuleExtendsOrAmendsClauseContext) => void;
    /**
     * Exit a parse tree produced by `PklTsParser.moduleExtendsOrAmendsClause`.
     * @param ctx the parse tree
     */
    exitModuleExtendsOrAmendsClause?: (ctx: ModuleExtendsOrAmendsClauseContext) => void;
    /**
